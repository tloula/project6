...
PlanCourse.create(plan_id: plan1.id, course_id: course21.id, term: "Spring", year: 2018)
PlanCourse.create(plan_id: plan1.id, course_id: course26.id, term: "Fall", year: 2018)
...
PlanCourse.create(plan_id: plan1.id, course_id: course23.id, term: "Fall", year: 2019)
PlanCourse.create(plan_id: plan1.id, course_id: course24.id, term: "Fall", year: 2019)
